      ...
      <div className="flex-grow">
        ...
        {typeof recommended !== 'undefined' && (
          <div className={
            clsx(
              "flex mt-5",
              !recommended?.checked && "opacity-50"
            )
          }>
    ...
    <div className="mb-10 overflow-auto">
      <nav className="mb-6" style={{ boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>
        <div className="flex justify-between container py-6">
          ...
          <button onClick={() => onClose.call(null)} className="text-lena-pink-dark flex items-center focus:ring-0 focus:outline-none">Fermer <img className="ml-3" src={CloseSvg} alt="Cross Icon" /></button>
        </div>
      </nav>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            >
              ...
              <Skill star={4} title="Agir collectivement" description="Je fais des propositions au groupe, j'écoute et prends en compte l'avis de chacun, exprime des avis contraires." bottom={true} />
            ...
            >
              ...
              <Skill star={4} title="Prendre en compte les codes sociaux dans l’activité" description="Je fais des propositions au groupe, j'écoute et prends en compte l'avis de chacun, exprime des avis contraires." bottom={true} />
