...
const Job = () => {
  return (
    <div className="bg-lena-lightgray px-5 py-7 rounded-lg mb-3">
      <h3 style={{ color: '#424242' }} className="font-bold mb-1">Technicien/ne démonstrateur/trice en matériel agricole</h3>
      ...
      <span className="bg-lena-blue-alt-light rounded-full font-bold text-sm py-2 px-3">
        DEUG, BTS, DUT
      </span>
    </div>
  );
    ...
    <div>
      <header style={{ background: "#E5E5E5", boxShadow: "0px 4px 4px 0px #00000040" }} className="py-3">
        <div className="container flex justify-between items-center">
          <button className="focus:ring-0 focus:outline-none flex items-center space-x-3" onClick={() => history.push('/top_metiers/search')}>
      ...
      <div className="container flex flex-col items-center mt-16 mb-5">
        ...
        <p className="text-lena-blue-dark text-sm text-center mt-5">
          En fonction des expériences, compétences et centres d’intérets que vous avez renseignés, voici <strong>10 métiers qui pourraient vous plaire :</strong>
        </p>
