...
const ButtonRegister: FunctionComponent<Props> = ({
  ...
  const classes = classNames([
    ...
    variant === "secondary" && "bg-lena-blue hover:bg-lena-blue-dark border border-transparent hover:bg-lena-blue-alt-dark",
    variant === "outline-secondary" && "border border-white bg-transparent hover:bg-opacity-20 hover:bg-white border-opacity-40 hover:border-opacity-70",
